package org.sklsft.demo.mvc.controller.reference.time.list.base;
...
import org.sklsft.demo.mvc.model.reference.time.list.CalendarListView;
...
redirect("/sections/reference/time/calendar/details.jsf?id=" + result);
}
});
}
/**
